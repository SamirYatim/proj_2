...
> **Примечание:** Для демонстрации работоспособности кода в репозитории используется генератор синтетических данных, имитирующий структуру реальных временных рядов (сезонность температуры, зависимость NDVI от осадков).
...
*(Графики генерируются автоматически при запуске скрипта)*
